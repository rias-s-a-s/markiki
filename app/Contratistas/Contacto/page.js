    ...
    <div>
      <div className="bg-white">
        <div className="container mx-auto my-4 px-4 lg:px-20  ">
          ...
          >
            ...
            <div className="my-2 w-1/2 lg:w-1/4">
              <button
                className="uppercase text-sm font-bold tracking-wide bg-[#0386ba] text-gray-100 p-3 rounded-lg w-full hover:scale-105 
        focus:outline-none focus:shadow-outline"
          ...
          <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-8 ml-auto bg-[#0386ba] rounded-2xl">
...
export default ContactoContratistas;

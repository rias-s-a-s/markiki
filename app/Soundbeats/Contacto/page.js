    ...
    <div>
      <div className="bg-white">
        <div className="container mx-auto my-4 px-4 lg:px-20  ">
          ...
          >
            ...
            <div className="my-2 w-1/2 lg:w-1/4">
              <button
                className="uppercase text-sm font-bold tracking-wide bg-gradient-to-r from-[#e10c5b] to-[#762982] text-gray-100 p-3 rounded-lg w-full hover:scale-105 
        focus:outline-none focus:shadow-outline"
          ...
          <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-8 ml-auto bg-gradient-to-r from-[#e10c5b] to-[#762982] rounded-2xl">
...
export default ContactoSoundBeats;
